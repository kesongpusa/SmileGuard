    ...
    const login = async (email, password, expectedRole)=>{
        ...
        try {
            ...
            if (data.user) {
                ...
                const { data: profile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$supabase$2d$client$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["supabase"].from("profiles").select("role, name, email").eq("id", data.user.id).single();
